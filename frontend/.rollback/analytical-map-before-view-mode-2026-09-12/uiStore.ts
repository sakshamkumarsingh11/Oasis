...
type State={scenario:ScenarioId; selectedFeature:string|null; selectedVessel:string|null; layers:Record<string,boolean>; visualMode:'enhanced'|'classic'; setScenario:(s:ScenarioId)=>void; selectFeature:(s:string|null)=>void; selectVessel:(s:string|null)=>void; setVisualMode:(mode:'enhanced'|'classic')=>void; toggleLayer:(s:string)=>void};
